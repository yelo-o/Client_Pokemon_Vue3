            ...
            <div class="form-row">
                <div class="form-group col">
                    ...
                    <div class="form-check">
                        <Field name="role" class="form-check-input" type="radio" id="roleId1" value="ROLE_USER"
                ...
                <div class="form-group col">
                    <label></label>
                    <div class="form-check">
                        <Field name="role" class="form-check-input" type="radio" id="roleId2" value="ROLE_ADMIN"
                            :class="{ 'is-invalid': errors.role }" />
